...
function ComingSoon() {
  ...
  return (
    <div className="min-h-[100dvh] overflow-x-hidden overflow-y-auto bg-[#020816] text-white">
      ...
      <main className="relative mx-auto flex min-h-[100dvh] max-w-4xl items-start px-3 pt-5 pb-16 sm:items-center sm:px-6 sm:py-8 sm:pb-8 lg:px-8">
        <section className="relative mt-1.5 w-full overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-2.5 shadow-2xl shadow-black/35 backdrop-blur-xl sm:mt-0 sm:p-6">
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/10 px-2.5 py-1.5 text-[10px] font-semibold uppercase tracking-[0.24em] text-cyan-300 sm:px-3 sm:text-[11px] sm:tracking-[0.28em]">
                <Sparkles size={12} className="animate-pulse sm:size-[13px]" />
                Model Preview
              </div>
              ...
              <div className="mt-3 grid gap-2.5 sm:mt-5 sm:grid-cols-2 sm:gap-3">
                <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-2.5 transition duration-300 hover:-translate-y-0.5 hover:border-cyan-400/20 hover:bg-white/[0.05] sm:p-3">
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-2.5 transition duration-300 hover:-translate-y-0.5 hover:border-blue-400/20 hover:bg-white/[0.05] sm:p-3">
              ...
              <div className="mt-4 flex flex-col gap-2.5 sm:mt-5 sm:flex-row">
                <Link
                  to="/prediction"
                  className="group inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-cyan-400 via-blue-500 to-violet-600 px-4 py-2.5 text-sm font-bold text-white shadow-lg shadow-blue-950/25 transition duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-blue-900/35"
                >
                  <ArrowLeft
                    size={15}
                ...
                <div className="inline-flex items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-2.5 text-sm text-slate-300">
